...
const BounceTrueInResponsibleOnBounceInContract = require('./bounce-true-in-responsible-onbounce-in-contract')
const CheckSendResultChecker = require('./check-send-result')
const CompilerVersionChecker = require('./compiler-version')
const DefaultFlagBounceIsOmited = require('./default-flag-bounce-is-omitted')
...
const ResponsibleWithoutFlag = require('./responsible-without-flag')
const StateVisibilityChecker = require('./state-visibility')
const TvmAcceptBeforeRequire = require('./tvm-accept-before-require')
const TwoRawReserve = require('./two-raw-reserve')
...
module.exports = function security(reporter, config, inputSrc) {
  return [
    ...
    new BounceTrueInResponsibleOnBounceInContract(reporter),
    new CheckSendResultChecker(reporter),
    new CompilerVersionChecker(reporter, config),
    new DefaultFlagBounceIsOmited(reporter),
    ...
    new ResponsibleWithoutFlag(reporter),
    new StateVisibilityChecker(reporter),
    new TvmAcceptBeforeRequire(reporter),
    new TwoRawReserve(reporter)
  ]
}
